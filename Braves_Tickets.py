...
import ipynb
from ipynb.fs.full.Ticket_Scraper_Utils import *




#STEP 1 (enter the date for the game you want to record)
hs = pd.read_csv('/Users/wjrowesr/Library/CloudStorage/OneDrive-KennesawStateUniversity/Tickets/GameTicketPromotionPrice.csv')
